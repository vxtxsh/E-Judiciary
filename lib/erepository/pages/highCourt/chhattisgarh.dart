...
class Chhc extends StatelessWidget {
  const Chhc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Chhattisgarh High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'hcbspjudgement/query/jud_status_oj_new_ncn.php?',
