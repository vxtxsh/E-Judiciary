...
class kehc extends StatelessWidget {
  const kehc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Kerala High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hckinfo.kerala.gov.in/digicourt/Casedetailssearch/Statuscaseno',
