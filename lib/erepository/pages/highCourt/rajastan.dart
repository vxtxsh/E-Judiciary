...
class rahc extends StatelessWidget {
  const rahc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Rajasthan High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcraj.nic.in/ciscopying-status-jdp/index.php',
