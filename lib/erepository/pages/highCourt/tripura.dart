...
class trihc extends StatelessWidget {
  const trihc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Tripura High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcservices.ecourts.gov.in/ecourtinditrihc/cases/s_kiosk_order.php?state_cd=20&dist_cd=1&court_code=1&stateNm=Tripura',
