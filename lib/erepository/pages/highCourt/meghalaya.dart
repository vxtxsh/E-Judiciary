...
class mehc extends StatelessWidget {
  const mehc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Meghalaya High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://meghalayahighcourt.nic.in/case-status',
