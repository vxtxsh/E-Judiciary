...
class jhhc extends StatelessWidget {
  const jhhc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Jharkhand High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcservices.ecourts.gov.in/ecourtindijhhc/cases/s_kiosk_order.php?state_cd=7&dist_cd=1&court_code=1&stateNm=Jharkhand',
