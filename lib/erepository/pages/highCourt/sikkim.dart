...
class sihc extends StatelessWidget {
  const sihc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Sikkim High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcs.gov.in/hcs/hcourt/hg_judgement_search',
