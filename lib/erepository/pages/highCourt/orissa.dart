...
class ohc extends StatelessWidget {
  const ohc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Orissa High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcservices.ecourts.gov.in/ecourtindiohc/cases/s_kiosk_order.php?state_cd=11&dist_cd=1&court_code=1&stateNm=Odisha/',
