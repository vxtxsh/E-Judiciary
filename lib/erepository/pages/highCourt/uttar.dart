...
class utthc extends StatelessWidget {
  const utthc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Uttarakhand High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcservices.ecourts.gov.in/ecourtindiutthc/cases/s_kiosk_order.php?state_cd=15&dist_cd=1&court_code=1&stateNm=Uttarakhand',
