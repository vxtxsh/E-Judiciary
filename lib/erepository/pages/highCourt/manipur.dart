...
class manhc extends StatelessWidget {
  const manhc({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Manipur High Court',style: TextStyle(color: Colors.white),),
          backgroundColor:
      ...
      body: WebView(
        initialUrl:
            'https://hcservices.ecourts.gov.in/ecourtindimanhc/cases/s_kiosk_order.php?state_cd=25&dist_cd=1&court_code=1&stateNm=Manipur',
