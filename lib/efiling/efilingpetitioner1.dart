...
import 'efilingpetitioner2.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';

class petitioner extends StatefulWidget {
  const petitioner({super.key});

  @override
  State<petitioner> createState() => _petitionerState();
}

class _petitionerState extends State<petitioner> {
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const petitioner2()),
                      );
                    },
                  ),
                ),
